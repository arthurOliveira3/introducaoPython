...
def aumento_preco(preco):
    ...
    """
    if preco <= 280:
        return (preco, 20, preco * 0.2, preco + preco * 0.2)
    elif preco <= 700:
        return (preco, 15, preco * 0.15, preco + preco * 0.15)
    elif preco <= 1500:
        return (preco, 10, preco * 0.1, preco + preco * 0.1)
    else:
        return (preco, 5, preco * 0.05, preco + preco * 0.05)
...
def converte_hora_24_para_12(horario):
    ...
    if hora == "00":
        ...
        return f"{int(hora)}:{minutos} am"
    elif hora == "12":
        return f"{int(hora)}:{minutos} pm"
    else:
        return f"{int(hora) - 12}:{minutos} pm"
